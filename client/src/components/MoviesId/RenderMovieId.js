  ...
  return (
    <MovieContainer>
      ...
      <MovieInfoTop>
        ...
        <DateRuntime>
          <p style={{ fontWeight: "bold", marginRight: ".5rem" }}>
          ...
          {youtube ? (
            <>
              <iframe
                title={youtube}
                style={
                  youtubeLoaded ? { display: "block" } : { display: "none" }
                }
                onLoad={() => setyoutubeLoaded(true)}
                id="player"
                type="text/html" //width="500" height="300"
              ...
              <SpinnerContainer
                style={
                  youtubeLoaded ? { display: "none" } : { display: "block" }
                }
              >
                <ClipLoader />
                <p>Loading Trailer</p>
