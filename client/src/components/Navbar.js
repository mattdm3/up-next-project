      ...
      <StyledNav>
        ...
        >
          ...
          <OverlayMenu>
            ...
            <HiddenNavLink onClick={toggleNavbar} to="/genres/action">
              <li>
                Browse{" "}
            ...
            {appUser && appUser.email ? (
              <>
                ...
                <HiddenNavLink to="/" onClick={toggleNavbar}>
                  ...
                  >
                    Logout{" "}
                    <span role="img" aria-label="exit-door">
                      🚪
                    </span>
                  </StyledNavLink>
                </HiddenNavLink>
              ...
              <>
                ...
                >
                  {" "}
                  <p style={{ paddingRight: ".5rem" }}>Get Started</p>{" "}
                  <UserIcon />
                </StyledNavLink>

                <LearnMoreButton onClick={() => history.push("/")}>
                  How it works
                </LearnMoreButton>
              </>
            )}
          ...
          {appUser && appUser.email ? (
            <>
              <NavigationLink exact to={`/profile/${appUser.uid}`}>
                ...
                {dataObject &&
                  dataObject.upNextList &&
                  dataObject.upNextList.length &&
                  navbar === false && (
                    <UpNextAmount>
                      {dataObject &&
                        dataObject.upNextList &&
                        (dataObject.upNextList[0] === "none"
                          ? "0"
                          : dataObject.upNextList.length)}
                    </UpNextAmount>
                  )}
...
const OverlayMenu = styled.ul`
  ...
  li {
    ...
    /* color: ${({ theme }) =>
      theme === lightTheme ? "#8D89C8" : "#050553"}; */
